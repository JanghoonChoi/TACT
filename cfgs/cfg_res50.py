...
name_bbnet       = 'resnet50'          # choose backbone : [resnet18, resnet34, resnet50, wide_resnet50_2, resnext50_32x4d]
...
CHKPT_PATH, INITP_PATH = 'ckpt/', 'init/init_res50_weights.tar'
CHKPT_CODE = ''
